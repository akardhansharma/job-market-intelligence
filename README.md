...
### 2. SQL — Analysis in SSMS
Run scripts in order against the `JobMarketIntelligence` database:
...
- Update SQL Server connection to your local instance
- Refresh data
...
- Key fields: job title, company, location, salary, schedule type, skills
